<script setup>
/**
 * postFeed.vue — card de post no feed
 *
 * Post schema: { title, excerpt, content_md, cover_url, slug, id,
 *   created_at, updated_at, likes_count, comments_count, meta, author_id,
 *   approved, tags }
 */
...
onMounted(async () => {
  if (props.post.author_id) {
    postAuthor.value = await getUser(props.post.author_id)
  }
})
...
// Limita a 4 tags no card para não poluir
  ...
  >
    <div class="p-7 md:p-8 flex flex-col">
      ...
      <div class="flex items-center gap-3 mb-4 flex-wrap">
        <div class="w-7 h-7 flex-shrink-0 rounded-full bg-gradient-to-br from-[#079272] to-[#2464E8] flex items-center justify-center text-white text-[0.6rem] font-bold">
          {{ authorInitial }}
        </div>
